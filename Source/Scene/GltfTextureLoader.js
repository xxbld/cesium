...
function unload(textureResourceLoader) {
  if (defined(textureResourceLoader._texture)) {
    textureResourceLoader._texture.destroy();
  }

  if (defined(textureResourceLoader._imageLoader)) {
    var resourceCache = textureResourceLoader._resourceCache;
    resourceCache.unload(textureResourceLoader._imageLoader);
  }

  textureResourceLoader._imageLoader = undefined;
  textureResourceLoader._image = undefined;
  textureResourceLoader._texture = undefined;
  textureResourceLoader._gltf = undefined;
}
 ...
 *
 * @see GltfTextureLoader#destroy
 */
GltfTextureLoader.prototype.isDestroyed = function () {
  return false;
};
 ...
 *
 * @example
 * textureLoader = textureLoader && textureLoader.destroy();
 *
 * @see GltfTextureLoader#isDestroyed
 */
GltfTextureLoader.prototype.destroy = function () {
  unload(this);
